...
const commands = [
    { cmd: "whoami", output: "Abdi Ali Abdi" },
    { cmd: "cat skills.json", output: '["React", "Next.js", "TypeScript", "Node.js", "TailwindCSS"]' },
    ...
    return (
        ...
        >
            ...
            <div className="bg-white/5 p-3 flex items-center justify-between border-b border-white/5">
                ...
                <div className="text-gray-500 text-xs tracking-widest uppercase">abdi@dev-terminal</div>
                <div className="w-8" />
            </div>
