                    ...
                    >
                        <GlassCard className="p-8 md:p-12 relative overflow-hidden bg-black/70 border-neon-cyan/30">
                            ...
                            <p className="text-gray-400 text-lg mb-10 leading-relaxed font-light">
                                Whether it&apos;s about collaboration, internship opportunities, open-source projects, or just a conversation about tech — I&apos;m always open to connecting with passionate engineers and builders.
                            </p>
