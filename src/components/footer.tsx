...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: <FaLinkedin />, url: "https://www.linkedin.com/in/abdi-ali-abdi/", label: "LinkedIn" },
    { icon: <FaEnvelope />, url: "mailto:abdialiaa200@gmail.com", label: "Email" },
  ];
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-0">
          ...
          <div className="flex flex-col items-center md:items-start order-2 md:order-1">
            ...
            <p className="text-xs text-gray-500 font-mono">
              © {currentYear} Abdi Ali Abdi. All Protocols Secured.
            </p>
          </div>
